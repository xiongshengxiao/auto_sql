set mapred.job.name=job_ods_dms_uc_uc_assessment_info_init;
...
, vinno --车架号
, ass_date --评估日期
, appraiser_memo --评估师寄语
, appraiser_account --评估师账号
, appraiser_name --评估师名称
, check_manage_no --检查管理No
, vehicle_config_info_json --车辆配置信息Json
, vehicle_check_remark_json --车辆检查备注Json
, vhcl_check_remark_label_json --车辆检查备注标签Json
, vehicle_addi_check_json --车辆额外检查Json
, vehicle_img_json --车辆图片Json
, vehicle_defect_info_json --车辆缺陷信息Json
, imp_service_info_json --重要维修保养信息Json
, update_account --更新账号
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
...
set mapred.job.name=job_ods_dms_uc_uc_assessment_ledger_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, gearbox_type --变速箱类型
, gearbox_name --变速箱名称
, gearbox_category --变速箱分类
, gearbox_category_name --变速箱分类名称
...
, related_type --关联类型
, related_id --关联ID
, sales_decision_time --销售决策时间
, sales_decision_status --销售决策状态
, plan_sales_method --计划销售方式
, retail_ref_sales_price --零售参考销售价格
, retail_plan_sales_price --零售计划销售价格
, retail_ref_purchase_price --零售参考采购价格
, retail_plan_purchase_price --零售计划采购价格
, retail_bench_gross_profit --零售基准毛利
, retail_plan_gross_profit --零售计划毛利
, whsle_ref_sales_price --批售参考销售价格
, whsle_plan_sales_price --批售计划销售价格
, whsle_ref_purchase_price --批售参考采购价格
, whsle_plan_purchase_price --批售计划采购价格
, whsle_bench_gross_profit --批售基准毛利
, whsle_plan_gross_profit --批售计划毛利
, new_vehicle_guide_price --新车指导价格
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_authen_apply_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, branch_code --店铺代码
, vehicle_manage_no --车辆管理编号
, auth_apply_no --认证申请编号
, first_regist_date --首次注册日期
, vinno --车架号
, uc_auth_no --二手车认证编号
, authen_type --认证类型
, other_dealer_authen_flag --其他销售店认证标识
, authen_apply_type_code --认证申请类型CD
, auth_status --认证状态
, cancel_reason_type --取消原因类型
, auth_apply_time --认证申请时间
, authen_apply_staff_account --认证申请担当账号
, authen_apply_staff_name --认证申请担当姓名
, authen_operate_time --认证操作时间
, authen_operate_account --认证操作账号
, authen_operate_staff_name --认证操作担当姓名
, authen_operate_opinion --认证操作意见
, uc_auth_time --二手车认证生效时间
...
set mapred.job.name=job_ods_dms_uc_uc_cust_car_buy_follow_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, negotiation_id --商谈ID
, follow_time --跟进时间
, car_buy_follow_status --买车跟进状态
, follow_account --跟进账号
, follow_staff_name --跟进担当姓名
, car_buy_follow_result --买车跟进结果
, continue_reason_type --继续原因类型
, abandon_reason_type --放弃原因类型
, vehicle_manage_no --车辆管理编号
, contact_diff --联系区分
, contact_content_code --联系内容代码
, customer_expect_price --客户期望价格
, prompt_price --提示价格
, intn_level --意向级别
, plan_follow_time --计划跟进时间
, plan_follow_content_diff --计划跟进内容区分
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_cust_car_sale_follow_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, negotiation_id --商谈ID
, follow_time --跟进时间
, car_sale_follow_status --卖车跟进状态
, follow_account --跟进账号
, follow_staff_name --跟进担当姓名
, car_sale_follow_result --卖车跟进结果
, continue_reason_type --继续原因类型
, abandon_reason_type --放弃原因类型
, vehicle_manage_no --车辆管理编号
, contact_diff --联系区分
...
set mapred.job.name=job_ods_dms_uc_uc_cust_sales_vio_settl_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
insert overwrite table ods.ods_dms_uc_uc_cust_sales_vio_settl
select  id --主键
, buyer_sales_violation_serial --买方销售违约编号
, dealer_code --销售店代码
, branch_code --店铺代码
, vehicle_manage_no --车辆管理编号
, vinno --车架号
, sales_contract_serial --销售合同编号
, violation_amount --违约金额
, settl_status --结算状态
, finish_payment_time --完成付款时间
, input_date --录入日期
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
...
set mapred.job.name=job_ods_dms_uc_uc_customer_info_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, customer_email --客户电子邮箱
, comm_activity_type --商业性活动类型
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_demand_info_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, uc_req_id --二手车需求ID
, uc_clue_id --二手车线索ID
, uc_req_status --二手车需求状态
, business_diff --业务区分
, sold_vehicle_model_name --售出车型名称
, icm_sold_vehicle_info_json --ICM售出车辆信息Json
, d2c_sold_vehicle_info_json --D2C售出车辆信息Json
, car_buy_intn_type --购车意向类型
, intn_new_vehicle_info_json --意向新车信息Json
, intn_uc_type --意向二手车类型
, intn_vehicle_manage_no --意向车辆管理编号
, intn_uc_cond_json --意向二手车条件Json
, purchase_type --购买类型
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
...
set mapred.job.name=job_ods_dms_uc_uc_dlr_sales_vio_settl_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
insert overwrite table ods.ods_dms_uc_uc_dlr_sales_vio_settl
select  id --主键
, seller_sales_violation_serial --买方销售违约编号
, dealer_code --销售店代码
, branch_code --店铺代码
, vehicle_manage_no --车辆管理编号
, vinno --车架号
...
set mapred.job.name=job_ods_dms_uc_uc_exchange_vehicle_relation_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
insert overwrite table ods.ods_dms_uc_uc_exchange_vehicle_relation
select  id --主键
, displace_vehicle_related_id --置换车辆关联ID
, dealer_code --销售店代码
, branch_code --店铺代码
, vehicle_manage_no --车辆管理编号
, vinno --车架号
, car_owner_name --车主名称
, displace_vehicle_manage_no --置换车辆管理编号
, displace_vinno --置换车架号
, displace_vehicle_picture_url --置换车辆图片路径
, displace_vehicle_config_grade --置换车辆配置等级
, displace_vehicle_model_code --置换车型代码
, displace_vehicle_model_name --置换车型名字
, displace_vehicle_nominee_name --置换车辆名义人姓名
, displace_vehicle_nominee_tel --置换车辆名义人电话
, displace_vehicle_sales_date --置换车辆销售日期
, displace_related_status --置换关联状态
, displace_related_time --置换关联时间
, displace_type --置换类型
, displace_vehicle_related_type --置换车辆关联类型
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_inventory_ledger_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, exterior_color_2 --外装色2
, ass_date --评估日期
, detect_work_order_finish_date --检测工单完成日期
, sales_decision_time --销售决策时间
, ref_sales_price --参考销售价格
, plan_sales_price --计划销售价格
, ref_purchase_price --参考采购价格
, plan_purchase_price --计划采购价格
, sign_type --签约类型
, sign_time --签约时间
, cons_contract_serial --寄售协议编号
, cons_contract_status --寄售协议状态
, cons_start_date --寄售开始日期
, cons_end_date --寄售结束日期
, cons_expect_price --寄售期望价格
, cons_type_code --寄售类型代码
, cons_service_cost --寄售服务费用
, purchase_contract_id --采购协议ID
, purchase_contract_status --采购协议状态
, purchase_sign_date --采购签约日期
, purchase_cancel_date --采购取消日期
, purchase_price --采购价格
, car_owner_name --车主名称
, car_owner_id_card --车主身份证号码
, car_owner_mobile_phone --车主电话
, car_owner_fixed_tel --车主固定电话
, sales_method --销售方式
, storage_method --入库方式
, storage_type --入库类型
, elect_defect_flag --机电缺陷标识
, vehicle_place_address --车辆放置地址
, related_type --关联类型
, related_id --关联ID
, plan_storage_date --计划入库日期
, actual_storage_date --实际入库日期
, transfer_flag --过户标识
, plan_transfer_date --计划过户日期
, actual_transfer_date --实际过户日期
, delivery_finish_date --交车完成日期
, dealer_pay_transfer_cost --销售店承担过户费用
, dealer_new_car_owner_name --销售店新车主姓名
, dealer_new_car_owner_id_card --销售店新车主身份证号码
, dlr_new_car_owner_mobile_phone --销售店新车主手机号
, dealer_new_car_owner_address --销售店新车主地址
, dlr_new_car_owner_lpn --销售店新车主车牌号
, displace_related_operate_flag --置换关联操作标识
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_inventory_ledger_transfer_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
set mapred.job.name=job_ods_dms_uc_uc_mst_dealer_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, dealer_name --销售店名称
, dealer_region --销售店区域
, dealer_address --销售店地址
, dealer_contact_tel --销售店联系电话
, dealer_website --销售店主页
, dealer_picture_url --销售店图片
, dealer_fax --销售店传真
, uc_dept_staff_telephone --二手车部担当电话
, business_start_time --营业开始时间
, business_end_time --营业结束时间
, dealer_theme_slogan --店的主题口号
, map_img --地图图片
, region_code --区域代码
, region_name --区域名称
, province_code --省代码
...
, ass_hotline --评估热线
, sales_hotline --销售热线
, dlr_image_display --销售店显示图片
, dealer_thumbnail_img --销售店缩略图片
, map_display_img --地图显示图片
, map_thumbnail_img --地图缩略图片
, contacts_account --联系人账号
, dealer_prefix --销售店前缀
, shop_enter_flag --商城入驻标识
, displace_cert_flag --置换资格标识
, displace_cert_effective_date --置换资格生效日期
, displace_cert_effective_flag --置换资格生效标识
, retail_cert_flag --零售资格标识
, retail_cert_effective_date --零售资格生效日期
, retail_cert_effective_flag --零售资格生效标识
, after_sales_service_flag --售后服务标识
, authen_service_flag --认证服务标识
, authen_service_contact_account --认证服务联系账号
, authen_service_contact_name --认证服务联系姓名
, authen_service_contact_telephone --认证服务联系电话
, authen_service_cost --认证服务费用
, maker_suggest_service_cost --厂商建议服务费用
, authen_service_remark --认证服务备注
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_mst_elect_defect_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
insert overwrite table ods.ods_dms_uc_uc_mst_elect_defect
select  id --主键
, detect_position_type --检测部位类型
, detect_position_group_code --检测部位组代码
, detect_position_code --检测部位代码
, sort --排序
, defect_item_name --缺陷项名称
, defect_item_name_local --缺陷项名称本地
, defect_item_name_2 --缺陷项名称2
, defect_item_name_2_local --缺陷项名称2本地
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_new_vhcl_exchange_achv_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
insert overwrite table ods.ods_dms_uc_uc_new_vhcl_exchange_achv
select  id --主键
, new_vehicle_displace_achv_id --新车置换业绩ID
, dealer_code --销售店代码
, branch_code --店铺代码
, vehicle_manage_no --车辆管理编号
, vinno --车架号
, license_plate_number --车牌号
, achv_apply_status --业绩申请状态
, present_type --赠品类型
, displace_vehicle_related_id --置换车辆关联ID
, displace_vehicle_vinno --置换车辆车架号
, displace_vehicle_nominee_name --置换车辆名义人姓名
, displace_vehicle_nominee_tel --置换车辆名义人电话
, displace_vehicle_sales_date --置换车辆销售日期
, displace_vehicle_picture_url --置换车辆图片路径
...
, displace_vehicle_model_code --置换车型代码
, displace_vehicle_model_name --置换车型名字
, purchase_obtain_evidence_id --采购取证ID
, invoice_number --发票号
, invoice_amount --发票金额
, actual_transfer_date --实际过户日期
, seller_name --卖方姓名
, seller_id_card --卖方身份证
, buyer_name --买主名
, buyer_id_card --买方身份证
, apply_time --申请时间
, apply_staff_account --申请担当账号
, apply_staff_name --申请担当姓名
, approve_time --审批时间
, approve_staff_account --审核担当账号
, approve_staff_name --审核担当姓名
, approve_opinion --审批意见
, cancel_time --取消时间
, cancel_staff_account --取消担当账号
, cancel_staff_name --取消担当姓名
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_purchase_contract_ledger_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, car_owner_id_card --车主身份证号码
, car_owner_mobile_phone --车主电话
, car_owner_tel --车主固定电话
, car_owner_zip --车主邮编
, car_owner_address --车主住址
, car_owner_email --车主邮箱
, license_plate_number --车牌号
, purchase_sign_date --采购签约日期
, purchase_cancel_date --采购取消日期
, cons_sign_date --寄售签约日期
, purchase_price --采购价格
, plan_sales_method --计划销售方式
, whsle_target_code --批售对象代码
, whsle_target_type --批售对象类型
, plan_storage_date --计划入库日期
, plan_transfer_date --计划过户日期
, purchase_contract_status --采购协议状态
, del_flag --删除标识
...
set mapred.job.name=job_ods_dms_uc_uc_purchase_contract_other_cost_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
insert overwrite table ods.ods_dms_uc_uc_purchase_contract_other_cost
select  id --主键
, purchase_other_cost_id --采购其他费用ID
, dealer_code --销售店代码
, branch_code --店铺代码
, vehicle_manage_no --车辆管理编号
, purchase_contract_id --采购协议ID
, cost_item_code --费用项代码
, cost_item_name --费用项名称
, cost_amount --费用金额
, cost_input_date --费用录入日期
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_repair_authen_ledger_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
insert overwrite table ods.ods_dms_uc_uc_repair_authen_ledger
select  id --主键
, repair_authen_id --整备认证ID
, dealer_code --销售店代码
, branch_code --店铺代码
, vehicle_manage_no --车辆管理编号
, vinno --车架号
...
, authen_type --认证类型
, auth_apply_time --认证申请时间
, auth_apply_by_code --认证申请人代码
, uc_auth_no --二手车认证编号
, gtmc_vehicle_flag --广汽丰田车辆标识
, delivery_finish_date --交车完成日期
, sales_method --销售方式
, first_regist_date --首次注册日期
, ass_date --评估日期
...
set mapred.job.name=job_ods_dms_uc_uc_repair_item_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, repair_item_type_name --整备项类型名称
, repair_item_cost --整备项费用
, retail_bench_cost --零售基准费用
, default_show_flag --默认展示标识
, brand_limit_diff --品牌限定区分
, default_choose_flag --默认选择标识
, sq --序列号
, repair_item_status --整备项状态
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
, update_by --更新者
...
set mapred.job.name=job_ods_dms_uc_uc_sales_contract_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
select  id --主键
, sales_contract_serial --销售合同编号
, old_nominee_name --旧名义人姓名
, old_nominee_telephone --旧名义人电话
, old_nominee_id_card --旧名义人身份证号码
, old_nominee_address --旧名义人住所
, old_license_plate_number --旧车牌号
, sales_method --销售方式
, retail_customer_type --零售客户类型
, retail_customer_name --零售客户姓名
, retail_customer_id_card --零售客户身份证号码
, retail_customer_mobile_phone --零售客户移动电话
, retail_customer_telephone --零售客户电话
, retail_customer_postal_code --零售客户邮编
, retail_customer_address --零售客户住所
, customer_id --客户ID
, negotiation_id --商谈ID
, whsle_target_type --批售对象类型
, whsle_car_trader_id --批售车商ID
, whsle_dealer_code --批售销售店代码
, whsle_branch_code --批售店铺代码
, whsle_coop_platform_code --批售合作平台代码
, whsle_target_name --批售对象名称
, whsle_contact_name --批售联系人名称
, whsle_target_mobile_phone --批售对象移动电话
, whsle_target_telephone --批售对象电话
, whsle_target_address --批售对象地址
, whsle_target_postal_code --批售对象邮编
, whsle_target_email --批售对象E-MAIL
, vehicle_user_type --车辆使用人类型
, vehicle_user_name --车辆使用人姓名
, vehicle_user_id_card --车辆使用人身份证号码
, vehicle_user_mobile --车辆使用人手机
, vehicle_user_telephone --车辆使用人电话
, vehicle_user_postal_code --车辆使用人邮编
, vehicle_user_address --车辆使用人地址
, vehicle_body_price_income --车辆本体价格收入
, vehicle_body_price_payment --车辆本体价格支出
, discount --折扣
, del_flag --删除标识
, create_by --创建者
, create_time --创建时间
...
set mapred.job.name=job_ods_dms_uc_uc_sales_contract_cost_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
set mapred.job.name=job_ods_dms_cs_vhcl_common_model_grade_config_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
insert overwrite table ods.ods_dms_cs_vhcl_common_model_grade_config
select  id --主键
, uc_franchise_code --二手车品牌编号
, uc_franchise_name --二手车品牌名称
, maker_code --厂商代码
, maker_name --厂商名称
, vehicle_model --车型
, vehicle_model_name --车型名称
, grade_name --等级名称
, vehicle_detail_config_id --车辆详细配置ID
, vehicle_detail_config_json --车辆详细配置Json
, sales_start_date --销售开始日期
, sales_end_date --销售结束日期
, vehicle_type_code --车辆类型代码
, vehicle_category_name --车辆类型名称
, new_vehicle_price --新车价格
, exhaust --排量
, national_standard_model --国标型号
, leave_factory_time --出厂时间
, vehicle_model_publish_year --车型发布年份
, country_release_code --国家公布代码
, production_status --生产状态
, production_time --生产时间
, stop_production_time --停产时间
, vehicle_model_info --车型信息
, vehicle_model_category --车型分类
, gear_type --档位类型
, car_length --车长
, car_width --车宽
, car_height --车高
, vehicle_door_number_serial --车门数编号
, rate_allow_people_serial --额定载客编号
, discharge_standard_serial --排放标准编号
, gearbox_type --变速箱类型
, drive_method_serial --驱动方式编号
, energy_type_code --能源类型代码
, fuel_consumption --油耗
, whole_weight --整备质量
, gearbox_category --变速箱分类
, gearbox_category_name --变速箱分类名称
...
set mapred.job.name=job_ods_dms_cs_maintain_uc_repair_entrust_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
...
, repair_status --整备状态
, repair_type --整备类型
, dealer_repair_start_time --销售店整备开始时间
, dealer_repair_end_time --销售店整备结束时间
, user_pay_repair_cost --用户承担整备费用
, dealer_repair_cost --销售店整备成本
, repair_entrust_id --整备委托ID
, repair_entrust_date --整备委托日期
, repair_entrust_appraiser_code --整备委托评估师代码
, repair_entrust_memo --整备委托留言
, maintain_order_no --维修工单号
, maintain_order_accept_date --维修工单受理日
, maintain_order_start_date --维修工单开始日
, maintain_order_complete_date --维修工单完成日
, maintain_order_cancel_date --维修工单取消日期
, maintain_order_cancel_reason --维修工单取消原因
, maintain_order_settl_date --维修工单结算日
, maintain_order_settl_fee --维修工单结算费用
, service_staff_account --服务担当账号
, nominee_type --名义人类型
, nominee_name --名义人姓名
, nominee_id_card --名义人身份证号码
, nominee_postal_code --名义人邮编
, nominee_telephone --名义人电话
, nominee_email --名义人EMAIL
, nominee_mobile_phone --名义人手机号
, uc_auth_flag --二手车认证标识
, uc_auth_no --二手车认证编号
, nominee_address --名义人住所
, create_time --创建时间
, create_by --创建者
, update_by --更新者
, update_time --更新时间
...
set mapred.job.name=job_ods_dms_cs_meta_second_level_source_init;
--set hive.exec.parallel=true;
--set hive.map.aggr=true;
--set hive.groupby.skewindata=true;
